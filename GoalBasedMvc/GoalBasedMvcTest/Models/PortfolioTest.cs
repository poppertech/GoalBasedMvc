...
namespace GoalBasedMvcTest.Models
{
    ...
    public class PortfolioTest
    {
        ...
        public void InitOnSuccessReturnsCorrectProbabilities()
        {
            ...
            var simulation2 = new Simulation { Price = 119.64969234571 };
            var simulation3 = new Simulation { Price = 127.005485296386 };
            ...
            var cashFlow1 = new CashFlow { Cost = 60000 };
            var cashFlows = new[] { cashFlow0, cashFlow1 };
